# Tottenham Community Choir - Members Area Reference

**Review Date:** 26 March 2026  
**Access:** Password protected (Password: Copland0!)  
**Purpose:** Complete documentation of members-only content for Nuxt rebuild

---

## Members Area Structure

### Accessible Pages (Password Protected)

1. ✓ **Members Area** (members-area.html) - Landing page
2. ✓ **Repertoire** (repertoire.html) - Current & past repertoire with practice tracks
3. ✓ **Comments and Chat** (comments-and-chat.html) - Member discussion
4. ✓ **Contact** (contact.html) - Members-only contact form/information
5. ✓ **Dress Code** (dress-code.html) - Performance dress guidelines
6. ✓ **Feedback** (feedback.html) - Member feedback system
7. ✓ **Members Gallery** (members-gallery.html) - Member photos
8. ✓ **Serving Refreshments** (serving-refreshments.html) - Refreshment duty info
9. ✓ **Video Gallery** (video-gallery.html) - Performance videos
...
**Note:** For instructions on programmatically accessing these password-protected pages, see [ACCESSING_MEMBERS_PAGES.md](ACCESSING_MEMBERS_PAGES.md)
...
10. **A Little Jazz Mass - Gloria**
    - Sop, Alto, Tenor, Bass
    - Files: `/uploads/4/3/9/1/43916423/chilcotts_gloria_[part].mp3`

11. **A Little Jazz Mass - Kyrie**
    - Sop1, Sop2, Alto1, Alto2, Tenor, Bass
    - Files: `/uploads/4/3/9/1/43916423/aljm_[part].mp3`

12. **Les Mis - One Day More**
    - Sop, Alto, Tenor, Bass
    - Files: `/uploads/4/3/9/1/43916423/les_mis_[part].mp3`

13. **Scarborough Fair/Skye Boat Song**
    - Sop1, Sop2, Alto, Tenor, Bass
    - Files: `/uploads/4/3/9/1/43916423/scarborough_song_[part].mp3`

14. **All Around My Hat**
    - Soprano, Alto, Tenor, Bass
    - Files: `/uploads/4/3/9/1/43916423/all_around_my_hat_[part].mp3`
...
16. **It Must Be Love**
    ...
    - External files: `https://mcusercontent.com/f9c3772c1b86e6bd327fff4cf/files/[...]/It_must_be_love_full_[part].mp3`
    - Tutti: `/uploads/4/3/9/1/43916423/it_must_be_love_tutti.mp3`

17. **Shenandoah**
    - [Backing Track and Tune](link tracking URL)
...
- Multiple vocal part splits (Sop1/Sop2, Alto1/Alto2, etc.)
- Pronunciation guides for foreign language pieces
- Tutti (all parts combined) recordings
...
**Note:** This is the password-protected members contact page, separate from any public contact information.
...
- Formal vs casual performance distinction
...
- Could include historical feedback
...
- Member headshots
- Group photos not for public viewing
...
## Migration Requirements for Nuxt
...
- file_url
- file_type (mp3, m4a)
- purpose (practice, pronunciation, tutti)
- created_at
...
1. **Audio Files**: Do you have all the source MP3/M4A files organized?
2. **Sheet Music**: Should PDF sheet music be added to the system?
3. **Jim's App**: Will you continue using the external loop player or build into Nuxt?
4. **User Management**: Should individual member accounts be created (vs single password)?
5. **Permissions**: Do different members need different access levels (admin, member, guest)?
6. **Content Update**: Who will update repertoire and upload new practice tracks?
7. **Rota System**: Does the refreshments rota need a scheduling/signup system?
8. **Comments**: What comment system is preferred (built-in, Disqus, custom)?

---

**End of Members Area Reference**
